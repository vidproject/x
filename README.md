...
| `@RapidResponse47` | Rapid Response 47 | 1,365 | 2025-01-31 | 2026-05-26 | 2026-05-26 | 1,250 | 1,009 |
...
| `@SecWar` | Secretary of War Pete Hegseth | 47 | 2025-02-25 | 2026-05-25 | 2026-05-26 | 82 | 30 |
...
| `@_misc` | Miscellaneous (replies / quotes / retweets of non-tracked accounts) | 6,066 | 2016-01-13 | 2026-05-26 | 2026-05-26 | 2,838 | 719 |

_Generated 2026-05-26T14:04:46Z._
...
- **Media not yet archived to GitHub Releases:** 13,977 of 20,721 media items are still `pending` (6,743 archived, 33%). Until a media item is uploaded its row keeps only the original (expiring) X CDN URL.
...
- **Accounts with no recent posts (>30d):** `@Readygov` (1526d), `@ERO__Phoenix` (405d), `@DHSBlueCampaign` (97d), `@AGPamBondi` (61d), `@EROSaltLakeCity` (48d). These may be quiet accounts or stalled captures.
