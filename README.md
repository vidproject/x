...
| ------ | ----- | -----: | ---------- | ----------- | -------------- | ----: | -----: |
| `@DHSgov` | Department of Homeland Security | 7,026 | 2016-01-11 | 2026-08-06 | 2026-08-07 | 4,664 | 1,207 |
| `@ICEgov` | U.S. Immigration and Customs Enforcement | 3,132 | 2016-03-28 | 2026-08-06 | 2026-08-07 | 2,549 | 489 |
| `@CBP` | U.S. Customs and Border Protection | 2,247 | 2016-03-21 | 2026-08-06 | 2026-08-07 | 1,762 | 221 |
...
_Generated 2026-08-07T13:26:59Z._
...
- **Media not yet archived to GitHub Releases:** 18,623 of 55,792 media items are still `pending` (37,169 archived, 67%). Until a media item is uploaded its row keeps only the original (expiring) X CDN URL.
...
- **Accounts with no recent posts (>30d):** `@ObamaWhiteHouse` (3485d), `@WhiteHouse45` (2024d), `@Readygov` (587d), `@WhiteHouse46` (563d), `@EroHarlingen` (244d), and 39 more. These may be quiet accounts or stalled captures.
