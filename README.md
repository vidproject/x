...
| `@_misc` | Miscellaneous (replies / quotes / retweets of non-tracked accounts) | 6,120 | 2016-01-13 | 2026-06-09 | 2026-06-11 | 2,885 | 739 |

_Generated 2026-06-11T14:13:00Z._
...
- **Media not yet archived to GitHub Releases:** 9,981 of 21,053 media items are still `pending` (11,071 archived, 53%). Until a media item is uploaded its row keeps only the original (expiring) X CDN URL.
