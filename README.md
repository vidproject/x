...
| ------ | ----- | -----: | ---------- | ----------- | -------------- | ----: | -----: |
| `@DHSgov` | Department of Homeland Security | 6,329 | 2016-01-11 | 2026-06-17 | 2026-06-19 | 4,146 | 1,039 |
| `@ICEgov` | U.S. Immigration and Customs Enforcement | 2,723 | 2016-03-28 | 2026-06-15 | 2026-06-19 | 2,201 | 425 |
...
| `@WhiteHouse` | The White House | 2,684 | 2025-01-20 | 2026-06-17 | 2026-06-19 | 2,387 | 572 |
...
| `@SecMullinDHS` | Secretary Markwayne Mullin | 127 | 2026-03-24 | 2026-06-17 | 2026-06-19 | 109 | 33 |
...
| `@_misc` | Miscellaneous (replies / quotes / retweets of non-tracked accounts) | 8,554 | 2016-01-13 | 2026-06-17 | 2026-06-19 | 4,754 | 1,166 |

_Generated 2026-06-20T11:47:16Z._
...
- **Media not yet archived to GitHub Releases:** 14,795 of 36,533 media items are still `pending` (21,738 archived, 60%). Until a media item is uploaded its row keeps only the original (expiring) X CDN URL.
...
- **Accounts with no recent posts (>30d):** `@Readygov` (539d), `@EroHarlingen` (196d), `@EROAtlanta` (156d), `@DHSBlueCampaign` (122d), `@AGPamBondi` (81d), and 7 more. These may be quiet accounts or stalled captures.
