...
_Generated 2026-05-23T00:55:10Z._
...
- **Media not yet archived to GitHub Releases:** 5,681 of 9,620 media items are still `pending` (3,931 archived, 41%). Until a media item is uploaded its row keeps only the original (expiring) X CDN URL.
- **Failed media archives:** 8 media items have `archive_status = failed` after retries and may be unrecoverable.
