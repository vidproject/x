...
| `@_misc` | Miscellaneous (replies / quotes / retweets of non-tracked accounts) | 6,379 | 2016-01-13 | 2026-05-30 | 2026-05-30 | 3,242 | 824 |

_Generated 2026-05-30T14:13:46Z._
...
- **Media not yet archived to GitHub Releases:** 1,226 of 10,056 media items are still `pending` (8,829 archived, 88%). Until a media item is uploaded its row keeps only the original (expiring) X CDN URL.
