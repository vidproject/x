...
| ------ | ----- | -----: | ---------- | ----------- | -------------- | ----: | -----: |
| `@DHSgov` | Department of Homeland Security | 5,253 | 2016-01-11 | 2026-05-22 | 2026-05-22 | 3,232 | 711 |
...
| `@WhiteHouse` | The White House | 288 | 2025-02-15 | 2026-05-20 | 2026-05-22 | 232 | 61 |
...
| `@_misc` | Miscellaneous (replies / quotes / retweets of non-tracked accounts) | 5,899 | 2016-01-13 | 2026-05-22 | 2026-05-22 | 2,976 | 749 |

_Generated 2026-05-23T10:03:50Z._
...
- **Media not yet archived to GitHub Releases:** 3,569 of 9,620 media items are still `pending` (5,558 archived, 58%). Until a media item is uploaded its row keeps only the original (expiring) X CDN URL.
- **Failed media archives:** 478 media items have `archive_status = failed` after retries and may be unrecoverable.
...
- **Accounts with no recent posts (>30d):** `@RealTomHoman` (556d). These may be quiet accounts or stalled captures.
