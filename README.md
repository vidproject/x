...
_Generated 2026-05-29T16:51:22Z._
...
- **Media not yet archived to GitHub Releases:** 2,387 of 9,835 media items are still `pending` (7,447 archived, 76%). Until a media item is uploaded its row keeps only the original (expiring) X CDN URL.
