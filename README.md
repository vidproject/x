...
| `@WhiteHouse45` | Trump White House Archive (45th Administration) | 809 | 2018-05-23 | 2021-01-20 | 2026-08-07 | 298 | 175 |
...
| `@_misc` | Miscellaneous (replies / quotes / retweets of non-tracked accounts) | 9,322 | 2016-01-12 | 2026-08-06 | 2026-08-07 | 5,370 | 1,306 |

_Generated 2026-08-07T03:15:12Z._
...
- **Media not yet archived to GitHub Releases:** 5,907 of 40,601 media items are still `pending` (34,694 archived, 85%). Until a media item is uploaded its row keeps only the original (expiring) X CDN URL.
...
- **Accounts with no recent posts (>30d):** `@ObamaWhiteHouse` (3485d), `@WhiteHouse45` (2024d), `@Readygov` (587d), `@EroHarlingen` (244d), `@EROAtlanta` (204d), and 38 more. These may be quiet accounts or stalled captures.
