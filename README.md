...
_Generated 2026-06-23T18:28:49Z._
...
- **Media not yet archived to GitHub Releases:** 7,752 of 36,533 media items are still `pending` (28,781 archived, 79%). Until a media item is uploaded its row keeps only the original (expiring) X CDN URL.
...
- **Accounts with no recent posts (>30d):** `@Readygov` (542d), `@EroHarlingen` (200d), `@EROAtlanta` (159d), `@DHSBlueCampaign` (126d), `@AGPamBondi` (85d), and 9 more. These may be quiet accounts or stalled captures.
