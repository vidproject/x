...
_Generated 2026-08-08T04:17:31Z._
...
- **Media not yet archived to GitHub Releases:** 28,590 of 68,298 media items are still `pending` (39,708 archived, 58%). Until a media item is uploaded its row keeps only the original (expiring) X CDN URL.
