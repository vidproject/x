...
- **Atomicity.** Parquet writes are `tmp.parquet` → `os.rename`.
  ...
  - **Categorize logically.** To be useful, tags must have overarching categories that are easy to understand, navigate, and filter for.
...
| `action:detention`      | `\b(arrest(?:ed\|ing)?\|detain(?:ed\|ing)?\|apprehend(?:ed\|ing)?\|in custody\|nab(?:bed)?)\b`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | 381   |  |
| `action:deportation`      | `\b(deport(?:ed\|ing\|ation)?\|remov(?:ed\|al)\|repatriat(?:ed\|ion))\b`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | 200   |  |
| `topic:border`       | `\b(border\|southwest\|crossing\|wall)\b`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | 112   |  |
| `origin:<NAME>`     | `\bfrom ([A-Z][a-zA-Z]+(?: [A-Z][a-zA-Z]+)?)\s*,`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | 233   | Validates against a fixed list of 195 sovereign-state names so "from John, his neighbor said …" doesn't false-positive. |
| `country:<NAME>`     | `([A-Z][a-zA-Z]+(?: [A-Z][a-zA-Z]+)?)\s*,`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | 233   | Validates against a fixed list of 195 sovereign-state names, but does not require a 'from', just tracks country mentions. |
...
| `shape:lineup` | `tweet_type == 'reply'` **and** matches `frame:criminal` **and** has 1 photo                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | 200+  | Composite tag — flags the highly templated mugshot-reply form. |
