...
def make_tweet(
    ...
    *,
    ...
    unavailable_detected_at: str | None = None,
    unavailable_reason: str | None = None,
    unavailable_text: str | None = None,
    unavailable_source_url: str | None = None,
    ...
    return {
        ...
        "unavailable_detected_at": unavailable_detected_at,
        "unavailable_reason": unavailable_reason,
        "unavailable_text": unavailable_text,
        "unavailable_source_url": unavailable_source_url,
        ...
        "author": {
            "display_name": f"Test user {handle}",
            "avatar_url": None,
            "verified": None,
