    ...
    assert (
        classify(
            "TheRealRazielah",
            {
                ...
                "description": (
                    "DEPUTY US MARSHAL RET. /1811 CRIMINAL INVESTIGATOR / U.S. ARMY SAPPER LEADER"
                ),
                "verified_type": None,
            },
        )
...
def test_build_keeps_badge_only_accounts_public(monkeypatch: pytest.MonkeyPatch) -> None:
    monkeypatch.setattr(
